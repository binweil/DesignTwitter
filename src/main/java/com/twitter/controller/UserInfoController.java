...
import com.twitter.config.Authorize;
...
public class UserInfoController {
    ...
    public @ResponseBody String getUserInfo (@CookieValue(value = "authToken", defaultValue = "") String token,
                                            @PathVariable(value = "username") String username,
                                            HttpServletResponse response) throws Exception {
        try {
            System.out.println("Runing into Controller");
            if (!authenticationService.isUserAuthorized(username, token)) {
                return null;
            }
